...
clang++ -std=c++20 -I eigen-3.4.0 -I csv-parser-2.3.0/include -c src/saver.cpp -o build/saver.o
...
clang++ -fopenmp build/main.o build/simulation.o build/particle.o build/mps.o build/bucket.o build/saver.o -o build/main.exe